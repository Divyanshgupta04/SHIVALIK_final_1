...
function About() {
  ...
  return (
    <div className={`min-h-screen w-full transition-colors duration-300 ${
      isDark ? 'bg-gradient-to-br from-gray-900 via-black to-gray-800' : 'bg-gradient-to-br from-blue-50 via-white to-gray-100'
    }`}>
      <div className="container mx-auto px-6 sm:px-8 py-16">
        ...
        >
          ...
          {/* World Map Section */}
          <div className={`max-w-5xl mx-auto mb-12 p-8 rounded-2xl relative overflow-hidden ${
            isDark 
            ...
            <div className="relative w-full" style={{ paddingBottom: '50%' }}>
              ...
              >
                ...
                <motion.div
                  ...
                  className={`absolute left-12 top-0 w-56 p-4 rounded-xl shadow-xl whitespace-nowrap ${
                    isDark 
