      ...
      <div className="space-y-4">
        ...
        <div>
          ...
          <input
            ...
            required
          />
          <p className={`mt-1 text-xs ${isDark ? 'text-gray-500' : 'text-gray-500'}`}>12 digits (demo validation).</p>
        </div>
            ...
            <div className="space-y-1 text-center">
              {aadhaarPhoto ? (
                <div className="relative inline-block">
                  <img src={aadhaarPhoto} alt="Preview" className="mx-auto h-48 rounded-lg object-contain" />
                  <button
                    type="button"
                    onClick={() => { setAadhaarPhoto(null); document.getElementById('aadhaar-upload').value = ''; }}
