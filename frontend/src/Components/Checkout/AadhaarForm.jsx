...
import { FiUploadCloud, FiCheck, FiTrash2, FiUser, FiCalendar, FiPhone, FiHash } from 'react-icons/fi';
    ...
    <form onSubmit={handleSubmit} className="space-y-8">
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        <div className="md:col-span-2">
          <label className={labelClasses}>Full Name (As per Aadhaar)</label>
        ...
        <div>
          ...
          <div className="relative">
            ...
            <input
              ...
              className={`${inputClasses} pl-12 tracking-[0.3em]`}
              ...
              {aadhaarPhoto ? (
                ...
                >
                  <div className="relative inline-block group/preview">
                    <img src={aadhaarPhoto} alt="Aadhaar card preview" className="max-h-64 rounded-2xl shadow-2xl mx-auto ring-4 ring-violet-500/20" />
                    <button
                      type="button"
                      onClick={(e) => { e.stopPropagation(); setAadhaarPhoto(null); }}
                ...
                >
                  ...
                  <div>
                    ...
                    <p className={`text-sm mt-1 font-medium ${isDark ? 'text-gray-500' : 'text-gray-400'}`}>
                      Clear image of your Aadhaar card (JPG, PNG • Max 2MB)
                    </p>
                  </div>
                </motion.div>
              )}
      ...
      <div className="flex flex-col sm:flex-row gap-4 pt-6">
        ...
        <button
          ...
          disabled={disabled || uploading || !form.consent || !aadhaarPhoto}
        >
